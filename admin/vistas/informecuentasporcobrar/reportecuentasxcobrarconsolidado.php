       ...
       <tbody>
            ...
            <tr>
              <td>
                 ...
                 <?php echo utf8_decode($nombrecliente); ?> 
              </a>
               </td>
             <td><?php echo utf8_decode("$".number_format($sumatotalventas,0)); ?></td>
              <td><?php echo utf8_decode("$".number_format($totalabonosporcliente,0)); ?></td>
              <td><?php echo utf8_decode("$".number_format($saldopendiente,0)); ?></td>
