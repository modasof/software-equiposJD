					...
					<div class="row">
						...
						<div class="col-md-6">
						  ...
						  <div class="card card-primary">
							...
							<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" name="nombre_equipo" placeholder="Nombre del equipo" class="form-control " required value="<?php echo utf8_decode($nombre_equipo) ?>">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label>Tipo Equipo: <span>*</span></label>
													 ...
													 <select class="form-control" id="tipo_equipo" name="tipo_equipo" required="">
															<option value="<?php echo utf8_decode($tipo_equipo) ?>" selected=""><?php echo utf8_decode($tipo_equipo) ?></option>
											...
											<div id="divplaca" class="col-md-6">
												<div class="form-group">
													...
													<input type="text" name="placa" placeholder="Digite la placa" class="form-control" value="<?php echo utf8_decode($placa) ?>">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label>Indicar marca<span>*</span></label>
													<input type="text" name="marca_equipo" placeholder="Digite la marca" class="form-control " required value="<?php echo utf8_decode($marca_equipo) ?>">
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" name="serial_equipo" placeholder="Digite el Serial" class="form-control" value="<?php echo utf8_decode($serial_equipo) ?>" >
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" name="modelo" placeholder="Modelo / Año " class="form-control" required value="<?php echo utf8_decode($modelo) ?>">
												</div>
											</div>
												...
												<div class="form-group">
													<label>Unidad de Trabajo: <span>*</span></label>
													 ...
													 <select class="form-control"  name="unidad_trabajo" required="">
															<option value="<?php echo utf8_decode($unidad_trabajo) ?>" selected=""><?php echo utf8_decode($unidad_trabajo) ?></option>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" name="propietario" placeholder="Digite el propietario" class="form-control" required value="<?php echo utf8_decode($propietario) ?>">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
							...
							<option value="<?php echo utf8_decode($modulo) ?>" selected=""><?php echo utf8_decode($modulo) ?></option>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="number" step="any" name="rend_interno" placeholder="Indique el consumo del equipo x hr ó km" class="form-control" required value="<?php echo utf8_decode($rend_interno) ?>">
												...
												<div class="form-group">
													<label>Unidad de Trabajo Interna: <span>*</span></label>
													 ...
													 <select class="form-control"  name="unidad_interna" required="">
															<option value="<?php echo utf8_decode($unidad_interna) ?>" selected=""><?php echo utf8_decode($unidad_interna) ?></option>
															<option value="HR">Horas</option>
															<option value="DIA">Días</option>
															<option value="MES">Mes</option>
															<option value="KM">Kilómetros</option>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="number" step="any" name="rend_externo" placeholder="Indique el consumo del equipo x hr ó km" class="form-control" required value="<?php echo utf8_decode($rend_externo) ?>">
												...
												<div class="form-group">
													<label>Unidad de Trabajo Externa: <span>*</span></label>
													 ...
													 <select class="form-control"  name="unidad_externa" required="">
															<option value="<?php echo utf8_decode($unidad_externa) ?>" selected=""><?php echo utf8_decode($unidad_externa) ?></option>
															<option value="HR">Horas</option>
															<option value="DIA">Días</option>
															<option value="MES">Mes</option>
															<option value="KM">Kilómetros</option>
											...
											<div class="col-md-12">
												<div class="form-group">
													<label>Observaciones<span>*</span></label>
													  <textarea class="form-control" rows="5" id="descripcion" name="observaciones"><?php echo utf8_decode($observaciones) ?>
													  </textarea>
												</div>
											</div>
										</div>
...
foreach($campos as $campo){
  ...
  $nombrequipo=gestiondocumentaleq::ObtenerNombreEquipo($equipo_id_equipo);
     ...
     ?> 
                  <tr>
                     <td><?php echo utf8_decode(fechalarga($fecha_reporte)); ?><br><small>Reportado el: <?php echo utf8_decode($marca_temporal);?></small></td>
                      <td><?php echo utf8_decode($num_trabajado." ".$unidad_trabajo); ?></td>
                    <td><?php echo utf8_decode($dias_trabajados); ?> días</td>
