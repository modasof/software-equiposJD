...
foreach ($campos as $campo) {
    ...
    ?>
            <tr>
              ...
              <td><?php echo utf8_decode($comision); ?> %</td>
              <td><?php echo utf8_decode($tipo_equipo); ?></td>
              <td><?php echo utf8_decode($marca_equipo); ?></td>
              <td><?php echo utf8_decode($inicial); ?></td>
              <td><?php echo utf8_decode(round($totalreporte, 1)); ?></td>
              <td><?php echo utf8_decode(round($odometroactual, 1)); ?></td>
              ...
              <td>
                ...
                <i class="fa fa-wrench bigger-110 ">  Registrar Mantenimiento</i>
              </a>
                          </li>
                          <li>
