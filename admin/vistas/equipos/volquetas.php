      ...
      <div class="clearfix">
          ...
          <thead>
            ...
            //$unidad_reportada=Equipos::obtenerNombreTipoUnidad($id_equipo);
              ...
              <td><a href="?controller=equipos&&action=editarvol&&id=<?php echo $id_equipo; ?>" class="tooltip-primary text-success" title="Editar Equipo"><?php echo utf8_decode($nombre_equipo); ?></a></td>
              <td><?php echo utf8_decode($placa); ?></td>
              <td><?php echo utf8_decode($propietario); ?></td>
              <td><?php echo utf8_decode(round(cubicajemaximo($id_equipo),1)); ?></td>
              <td><?php echo utf8_decode(round(cubicajeminimo($id_equipo),1)); ?></td>
               <td><?php echo utf8_decode(round(cubicajepromedio($id_equipo),1)); ?></td>
               <td><?php echo utf8_decode(round(Reportem3xequipo($id_equipo),1)); ?></td>
