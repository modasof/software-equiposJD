       ...
       <tbody>
        ...
        <?php
          ...
          $diaslaborados = Diaslaboradosvolquetaporfecha($equipo_id_equipo,$FechaStart,$FechaEnd);
            ...
            $totalmaterial= Facturacionmaterialporfecha($equipo_id_equipo,$FechaStart,$FechaEnd);
            ...
            <td class="success"><?php echo(number_format($totalmaterial,0)); ?></td>
            ...
            <td>$<?php echo(number_format($facturapromedio,0)) ?></td>
            <?php 
               if ($utilidadbruta<=0) {
