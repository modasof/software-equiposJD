        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php Echo utf8_decode("$ ".number_format($valor_total));  ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php Echo utf8_decode("$ ".number_format($Sumaabonos));  ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php Echo utf8_decode("$ ".number_format($SaldoPendiente));  ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
		...
		<!--Final Formulario Abonos-->
            ...
            $valor_abono = $campo['valor_abono'];
                ...
                <i class="fa fa-trash bigger-110 "></i>
                            	...
                            	<td><?php echo utf8_decode("$".number_format($valor_abono,0)); ?></td>
                            </tr>
                           <?php 
                       }
                            ?>	
