            ...
            <tr>
             <td><?php echo ($id) ?></td>
              ...
              <td><?php echo ($detalleorigen) ?></td>
               <td><a target="_blank" href="?controller=inventario&&action=entradasdetalle&&id=<?php echo($entrada_id); ?>"><?php echo utf8_decode($entrada_id); ?></a></td>
              <td><?php echo utf8_decode($nombrerecibe); ?></td>
               <td><?php echo utf8_decode($marca_temporal); ?></td>
               <td><?php echo utf8_decode($nominsumo); ?></td>
                <td><?php echo utf8_decode($cantidad); ?></td>
                 <td><?php echo utf8_decode($nomunidadmedida); ?></td>
               
                <td><?php echo utf8_decode("$".number_format($valorunitario)); ?></td>
               <td><?php echo utf8_decode("$".number_format($totalvalor)); ?></td>
