...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Contabilizar Ingresos Caja</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
					...
					<div class="row">
						...
						<div class="col-md-12">
						  ...
						  <div class="card card-primary">
							<!-- /.card-header -->
							<!-- form start -->
							<form role="form" action="?controller=ingresos&action=actualizarestadoingreso&&id=<?php echo($idreq);?>" method="POST" enctype="multipart/form-data">
								...
								<div class="row">
									...
									<div class="col-md-12">
										<div class="form-group">
										  <label for="sel1">Id Ingresos de Caja (separados por coma(,) :</label>
