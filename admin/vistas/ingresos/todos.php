...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Ingresos <?php echo utf8_decode($nombre_caja) ?></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php Echo utf8_decode("$ ".number_format($ingresoInicial));  ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php Echo utf8_decode("$ ".number_format($ingresosporcaja));  ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php Echo utf8_decode("$ ".number_format($ingresosporcuenta));  ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
      ...
      <div class="clearfix">
          ...
          $campos = $campos->getCampos();
            ...
            <tr>
              ...
              <td><?php echo utf8_decode($tipo_beneficiario) ?></td>
             <td><?php echo utf8_decode($fuente) ?></td>
