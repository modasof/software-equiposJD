...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Editar Egreso en <?php echo $egreso_en; ?>: <?php echo utf8_decode($nombre_cuenta); ?></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
											...
											<div  id="divcajas" class="col-md-12">
													<div class="form-group">
														  ...
														  <select class="form-control"  name="caja_beneficiada" >
																  <option selected="" value="<?php echo($caja_beneficiada) ?>" selected><?php echo utf8_decode($cajaselect) ?></option>
																<?php
