                    ...
                    <div class="card-body">
                            <div class="row">
                                ...
                                <select  class="form-control mi-selector0" id="origen_id" name="origen_id" required>
                                        ...
                                        ?>
                                        <option value="<?php echo $id_destino1; ?>"><?php echo utf8_decode($nombre_destino1); ?></option>
                                        <?php } ?>
                                </select>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo utf8_decode($id) ?></td>
               <td><?php echo utf8_decode($nomorigen) ?></td>
                <td><?php echo utf8_decode($nomdestino) ?></td>
              <td><?php Echo utf8_decode("$".number_format($valor_m3km));  ?></td>
              <td><?php echo utf8_decode($km_ruta) ?></td>
