          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center"><?php echo $id; ?> </td>
               <td><?php echo utf8_decode($nombrefuncionario); ?></td>
               <td><?php echo utf8_decode($tipo_novedad); ?></td>
              <td><?php echo utf8_decode(fechalarga($fecha_novedad)); ?></td>
              <td><?php echo utf8_decode($observaciones); ?></td>
               <td><?php echo utf8_decode($reportado_por); ?></td>
              <td>
