...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Egresos <?php echo utf8_decode($nombre_cuenta) ?></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php Echo utf8_decode("$ ".number_format($egresosacuentas));  ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php Echo utf8_decode("$ ".number_format($egresosacajas));  ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php Echo utf8_decode("$ ".number_format($egresosaotros));  ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php Echo utf8_decode("$ ".number_format($totalegresos));  ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
          ...
          <tbody>
           ...
           elseif ($cuenta_beneficiada!=0) {
            ...
            <tr>
              ...
              <td><?php echo utf8_decode($tipo_egreso) ?>
                <br>
                Registro Nº. <?php echo($id_egreso_cuenta); ?>
              </td>
             <td><?php echo utf8_decode($nombrebeneficiario) ?></td>
               <td><?php 
                if ($id_subrubro!=0) {
