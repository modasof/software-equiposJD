		...
		<div class="card card-primary">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo utf8_decode($nombre_funcionario); ?></td>
              ...
              else
              {
               ...
               <td><?php echo utf8_decode($fecha); ?></td>
               <td><?php 
               if ($estado=='Activo') {
                 echo utf8_decode("<span class='text-success'>".$estado."<span>");
               }
               else
               {
                echo utf8_decode("<span class='text-danger'>".$estado."<span>");
               }
               ...
               ?></td>
                <td>
                <?php 
                echo utf8_decode($empresa);
                //if ($estado=='Activo') {
                  // echo utf8_decode("$ ".number_format($salario));
                //}
                //else
                //{
                  //echo utf8_decode("$ ".number_format(0));
                //}

                ?></td>
                 <td><?php echo utf8_decode($arl); ?></td>
                 <td><?php echo utf8_decode($eps); ?></td>
                 <td><?php echo utf8_decode($celular); ?><br>
                 <?php echo utf8_decode($correo); ?></td>
