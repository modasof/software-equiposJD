  ...
  console.log('New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')');
       ...
       <tbody>
            ...
            <tr>
              ...
              <td><?php echo utf8_decode($nombrecliente); ?></td>
              <td><?php echo utf8_decode($nombreproyecto); ?></td>
              <td><a href="?controller=requisicionesitems&&action=todosporreq&&id=<?php echo($id) ?>"> (<?php echo utf8_decode($totalitems); ?>) Insumos Solicitados</a></td>
              <td><?php echo utf8_decode($estadoactual); ?></td>
