...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h3 class="m-0 text-dark">Documentación Obligatoria <?php echo utf8_decode($Nombrecuenta); ?></h3>
        </div><!-- /.col -->
        <div class="col-sm-6">
      ...
      <div class="clearfix">
          ...
          <thead>
            ...
            elseif ($modulo_id_modulo==2) {
              ...
              <td><?php echo utf8_decode($asociado); ?></td>
              <td><?php echo utf8_decode($nombredocumento); ?></td>
              <td><?php echo utf8_decode($alerta); ?></td>
