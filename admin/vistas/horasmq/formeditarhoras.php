					...
					<div class="card-body">
							<div class="row">
								...
								<select class="form-control mi-selector" id="equipo_id_equipo" name="equipo_id_equipo" required>
										<option value="<?php echo ($equipo_id_equipo); ?>" selected><?php echo utf8_decode($nomequipo); ?></option>
										<?php
...
foreach ($rubros as $campo) {
    ...
    ?>
								...
								<select class="form-control" id="punto_despacho" name="punto_despacho" required>
										<option value="<?php echo ($punto_despacho); ?>" selected><?php echo utf8_decode($punto_despacho); ?></option>
										...
										<option value="<?php echo ($despachado_por); ?>" selected><?php echo utf8_decode($nomdespachadopor); ?></option>
										<?php
...
foreach ($rubros as $campo) {
    ...
    ?>
										<option value="<?php echo $id_funcionario; ?>"><?php echo utf8_decode($nombre_funcionario); ?></option>
										<?php }?>
								</select>
												</div>
											</div>
								...
								<select class="form-control mi-selector3" id="recibido_por" name="recibido_por" required>
										...
										<option value="<?php echo ($recibido_por); ?>" selected><?php echo utf8_decode($nomrecibidopor); ?></option>
										<?php
    ...
    ?>
										...
										<?php }?>
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<input type="text" name="valor_hora_operador" placeholder="Valor Hora Operador" class="form-control" id="demo2" value="<?php echo utf8_decode($valor_hora_operador); ?>">
												</div>
											</div>
							...
							<select style="width: 200px;" class="form-control mi-selector3" id="equipo_adicional" name="equipo_adicional" required>
								...
								<select class="form-control mi-selector3" id="cliente_id_cliente" name="cliente_id_cliente" required>
										...
										<option value="<?php echo ($cliente_id_cliente); ?>" selected><?php echo utf8_decode($nombrecliente); ?></option>
										<?php
...
foreach ($rubros as $campo) {
    ...
    ?>
										<option value="<?php echo $id_cliente; ?>"><?php echo utf8_decode($nombre_cliente); ?></option>
										<?php }?>
								</select>
												</div>
											</div>
								...
								<select class="form-control mi-selector3" id="proyecto_id_proyecto" name="proyecto_id_proyecto" required>
										...
										<option value="<?php echo ($proyecto_id_proyecto); ?>" selected><?php echo utf8_decode($nombreproyecto); ?></option>
										<?php
...
foreach ($rubros as $campo) {
    ...
    ?>
										<option value="<?php echo $id_proyecto; ?>"><?php echo utf8_decode($nombre_proyecto); ?></option>
										<?php }?>
								</select>
												</div>
											</div>
