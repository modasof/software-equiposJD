	...
	<div class="content">
		<div class="container-fluid">
			<div class="row">
             ...
             <input type="text" name="nombre_folder" value="<?php echo utf8_decode($nombre_folder);?>" class="form-control" id="nombre_folder" placeholder="Máximo 50 carácteres" maxlength="150" required>
              </div>
