...
<div class="content-wrapper">
  ...
  <div class="content">
    ...
    <div class="card card-primary">
      <div class="card-body">
          <a href="?controller=propietarios&&action=nuevo" class="btn btn-success" style="float: right;"><i class="fa fa-plus-square bigger-110 "></i> Crear Propietario</a>
          <br><br>
    ...
    <!--  <div class="card-header">
      ...
      <div class="clearfix">
       ...
       <tbody>
            ...
            ?>
            <tr>
              <td><?php echo utf8_decode($nombre_propietario); ?></td>
              <td>x</td>
