       ...
       <tbody>
            ...
            ?>
             <tr class='success text-success'>
              <td class="text-center"><?php echo utf8_decode($nombrecuenta); ?> </td>
              <td><a target="_blank" href="<?php echo($imagen); ?>"  class="tooltip-primary text-primary" title="Ver Soporte"><?php echo utf8_decode($nombredocumento); ?></a></td>
              <?php 
              if ($alerta=="Si") {
               ?>
                <td><?php echo utf8_decode($expira); ?></td>
                <td><?php echo utf8_decode($totaldias); ?> días</td>
                <td>
                <?php 
                if ($totaldias>30) {
                  ?>
