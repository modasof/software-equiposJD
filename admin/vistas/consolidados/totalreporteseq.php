...
foreach ($campos as $campo){
            ...
            $observaciones = $campo['observaciones'];
             ...
             <td><?php echo utf8_decode(fechalarga($fecha_reporte)); ?></td>
              <td class="text-center"><?php echo utf8_decode($num_trabajado); ?></td>
              <td class="text-center"><?php echo utf8_decode($dias_trabajados); ?></td>
              <td class="text-center"><?php echo utf8_decode($num_galones); ?></td>
              <td class="text-center"><?php echo utf8_decode("$".number_format($valor_combustible)); ?></td>
               <td><?php echo utf8_decode($nombreq); ?></td>
              
              <td><?php echo utf8_decode($nombrefun); ?></td>
