...
foreach ($campos as $campo) {
    ...
    ?>
            <tr>
              <td><?php echo utf8_decode($nombre_insumo); ?></td>
              <td><?php echo utf8_decode($nombrecategoria); ?></td>
               <td><?php echo utf8_decode("$ " . number_format($valorpromedio, 0)); ?>
                 <br>
                 <a href="?controller=cotizaciones&&action=todosporinsumo&&id=<?php echo($id) ?>">Ver Histórico</a>
               </td>
              <td><?php echo utf8_decode($EntradasIns); ?></td>
              <td><?php echo utf8_decode($SalidasIns); ?></td>
               <td><?php echo utf8_decode($SaldoInsumo); ?></td>
              <td><?php echo utf8_decode($Unidad); ?></td>
               <td><?php echo utf8_decode($parametrizado); ?></td>
                <td><?php echo utf8_decode($cantidadminima); ?></td>
              <td>
